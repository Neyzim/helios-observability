...
public class ProcessServiceAvailabilityImp implements ServiceAvailabilityInput {

    private final MonitoredServiceRepository monitoredServiceRepository;

    public ProcessServiceAvailabilityImp(MonitoredServiceRepository monitoredServiceRepository) {
